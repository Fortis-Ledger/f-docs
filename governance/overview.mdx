...
<Steps>
  <Step title="Access Governance Portal">
    Visit gov.fortisarena.io (launching Q4 2027)
  </Step>
...
The DAO treasury will hold:
- FRT tokens for development
- Stablecoins for operations
- LP tokens for protocol-owned liquidity

<Note>
  Treasury details and live balances will be published on the Treasury Dashboard once governance launches. All allocations will be fully transparent and on-chain verifiable.
</Note>
...
<Note>
  **Launching Q4 2027** — The following tools are under active development and will go live alongside the governance system:

  - **Governance Portal** (gov.fortisarena.io) — Submit and vote on proposals
  - **Community Forum** (forum.fortisarena.io) — Discuss proposals before voting
  - **Treasury Dashboard** (treasury.fortisarena.io) — Track DAO funds in real-time

  Join our [Discord](https://discord.gg/qTTYxTnK3s) for early access announcements.
</Note>
...
3. **Join Discord** - [Community discussions](https://discord.gg/qTTYxTnK3s) (Forum launching Q4 2027)
4. **Stay Updated** - Governance portal launching Q4 2027
